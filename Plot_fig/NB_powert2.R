...
data_plot = function(result, result_2, result_3, d,para){
  ...
  data1 = data.frame(n=N, 
                     ...
                     power_t=power_t, power_tR=power_tR,power_wmw=power_wmw,power_wc =power_wc, 
...
Data1 = readRDS("Simulation/NB/powert2/data_nb2_eq.rds")
M = Data1[["M"]]
N = Data1[["N"]]
alphax = Data1[["alphax"]]
Alphay = Data1[["Alphay"]]
...
result3 = readRDS('Simulation/NB/powert2/result_NB2_eq.rds')
result3_2 = readRDS('Simulation/NB/powert2/result_NB2_eq_comp.rds')
result3_3 = readRDS('Simulation/NB/powert2/result_NB2_eqg.rds')
data1 = data_plot(result3, result3_2, result3_3,d=4, para)
data2 = data_plot(result3, result3_2, result3_3,d=3, para)
data3 = data_plot(result3, result3_2, result3_3,d=2, para)
data4 = data_plot(result3, result3_2, result3_3,d=1, para)


Data1 = readRDS("Simulation/NB/powert2/data_nb2_ueq.rds")
M = Data1[["M"]]
N = Data1[["N"]]
alphax = Data1[["alphax"]]
Alphay = Data1[["Alphay"]]
...
Times = Data1[["Times"]]
para = list(M=M, N=N, alphax=alphax, Alphay=Alphay, beta=beta, Times=Times)
result4 = readRDS('Simulation/NB/powert2/result_NB2_ueq.rds')
result4_2 = readRDS('Simulation/NB/powert2/result_NB2_ueq_comp.rds')
result4_3 = readRDS('Simulation/NB/powert2/result_NB2_ueqg.rds')
data5 = data_plot(result4, result4_2, result4_3, d=4, para)
data6 = data_plot(result4, result4_2, result4_3, d=3, para)
data7 = data_plot(result4, result4_2, result4_3, d=2, para)
data8 = data_plot(result4, result4_2, result4_3, d=1, para)


Data1 = readRDS("Simulation/NB/powert2/data_nb2_eqt.rds")
M = Data1[["M"]]
N = Data1[["N"]]
alphax = Data1[["alphax"]]
Alphay = Data1[["Alphay"]]
...
Times = Data1[["Times"]]
para = list(M=M, N=N, alphax=alphax, Alphay=Alphay, beta=beta, Times=Times)
result3 = readRDS('Simulation/NB/powert2/result_NB2_eqt.rds')
result3_2 = readRDS('Simulation/NB/powert2/result_NB2_eqt_comp.rds')
result3_3 = readRDS('Simulation/NB/powert2/result_NB2_eqtg.rds')
dataeqt = data_plot(result3, result3_2, result3_3,d=1, para)


Data1 = readRDS("Simulation/NB/powert2/data_nb2_ueqt.rds")
M = Data1[["M"]]
N = Data1[["N"]]
alphax = Data1[["alphax"]]
Alphay = Data1[["Alphay"]]
...
Times = Data1[["Times"]]
para = list(M=M, N=N, alphax=alphax, Alphay=Alphay, beta=beta, Times=Times)
result4 = readRDS('Simulation/NB/powert2/result_NB2_ueqt.rds')
result4_2 = readRDS('Simulation/NB/powert2/result_NB2_ueqt_comp.rds')
result4_3 = readRDS('Simulation/NB/powert2/result_NB2_ueqtg.rds')
dataueqt = data_plot(result4, result4_2, result4_3, d=1, para)
...
delta_statues = c(delta1 = c(paste(paste('\u03B1\u005Fx',alphax,sep = "="),paste('\u03B1\u005Fy',95,sep = "="),sep=",")),
                  delta2=c(paste(paste('\u03B1\u005Fx',alphax,sep = "="),paste('\u03B1\u005Fy',90,sep = "="),sep=",")),
                  delta3=c(paste(paste('\u03B1\u005Fx',alphax,sep = "="),paste('\u03B1\u005Fy',80,sep = "="),sep=",")),
                  delta4=c(paste(paste('\u03B1\u005Fx',alphax,sep = "="),paste('\u03B1\u005Fy',75,sep = "="),sep=","))
)
...
delta_statues = c(delta4 = '\u03B1\u005Fx=\u03B1\u005Fy=100')
...
delta_statues = c(delta4 = c(paste('\u03B1\u005Fx=','\u03B1\u005Fy=',100)))
...
ggsave("Figure/Out_fig/NB_powert2_fig.png",width = 14,height =7.6)
