...
name_methods = c("Monocle","SCDE","MAST","DESeq","Limma","edgeR","ttest","ttestR","Welch","WMW",'ZINB-WaVE','DEsingle',
         'ZIAQ','aggregateBioVar','muscat',"WMW-A-G","WMW-A-GMM","WMW-A-LG","WMW-A-LGM",
         "WMW-A-NB","WMW-A-NBM","WMW-A(count)","consexpression","BaySeq","NOISeq","DEGnext")

list_names = c("Limma","ttest","ttestR","Welch","WMW",
               "BaySeq","consexpression","DEGnext","DESeq","edgeR","NOISeq",
                 'aggregateBioVar','DEsingle',"MAST","Monocle",'muscat',"SCDE",'ZINB-WaVE','ZIAQ',
                 "WMW-A-G","WMW-A-GMM","WMW-A-LG","WMW-A-LGM","WMW-A-NB","WMW-A-NBM","WMW-A(count)")
...
ggsave("Figure/Out_fig/MS_tpr_ueq.png",width = 16,height = 5.5)
...
ggsave("Figure/Out_fig/MS_fpr.png",width = 12,height = 5)
