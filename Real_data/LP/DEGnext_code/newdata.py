...
model = MyNetwork()
MyModelName='DEGnextModel_norm.pth'
...
File = '/Users/guoyin/Desktop/github/Real_data/LP/DEGnext_code/LP.csv'
xy = pandas.read_csv(File).values[:, 1:].astype('float32')
File = '/Users/guoyin/Desktop/github/Real_data/LP/DEGnext_code/LP_gene_label.csv'
...
cell_label = pandas.read_csv(File).values[:, 1:].astype('float32')

ntimes = 100
n1 = [50]#[5, 5, 5, 5, 10, 15]
n2 = [50]#[5, 10, 15, 20, 10, 15]
